        ...
        <main class="site-wrapper">
            <div class="pt-table">
                <div class="pt-tablecell page-home relative" style="background-image: url('img/banner.jpg');">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-8 col-md-offset-1 col-md-8 col-lg-offset-2 col-lg-8">
                                
                                <div class="page-title text-center">
                                    <h2>Hi. I am <span class="primary">Istiak</span> <span class="title-bg">Istiak</span></h2>
                                    <p>Web Developer & Designer / Wordpress Developer</p>
                                </div>
                                ...
                                <div class="hexagon-menu clear">
                                    ...
                                    <div class="hexagon-item">
                                        ...
                                        <a href="skills.php" class="hex-content">
                                            <span class="hex-content-inner">
                                                <span class="icon">
                                    ...
                                    <div class="hexagon-item">
                                        ...
                                        <a href="course.php" class="hex-content">
                                            <span class="hex-content-inner">
                                                <span class="icon">
                                                    <i class="tf-chat"></i>
                                                </span>
                                                <span class="title">Training & Courss</span>
                                            </span>
                                            <svg viewbox="0 0 173.20508075688772 200" height="200" width="174" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M86.60254037844386 0L173.20508075688772 50L173.20508075688772 150L86.60254037844386 200L0 150L0 50Z" fill="#1e2530"></path></svg>
                                        </a>
                                    </div>
